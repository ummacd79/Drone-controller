...
VSS_RunMode=0; % 0: simulation 1: real target
VSS_ControlMode=0; % 0: Time Based Hover, 1: Onscreen Control Hover 
...
%%  Bus definitions
load('busDefinition.mat') % use bus editor to edit this

%% open vicon data sender file
addpath('vicon')
% open_system('DSSDK_TrackerSingleObject.mdl')

%% add udp keyboard folder
addpath('keboardCommands')

takeoffCommand=false;
landCommand=false;

appGUI=GUI; % running GUI, and creating app handle
